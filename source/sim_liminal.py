...
def main():
    ...
    PLAN = {
        ...
        23: ((77.0, 299.00, 11.80), (77.0, 299.00, 11.80)),  # 影の階段 -> 棚の上へ
        24: ((56.0, 299.00, 13.30), (56.0, 299.00, 13.30)),  # 片持ちの段 -> 踊り場へ
        25: ((53.5, 304.00, 13.30), (53.5, 304.00, 13.30)),  # 北壁が割れる -> 出口
    }
    flats = {}
    ...
    PTS = [(0, 1.5, -7), (0, 1.5, 0), (0, 1.5, 12), (0, 1.5, 18), (-6.3, 1.5, 18.3),
           ...
           (68.0, 12.3, 289.0), (77.2, 12.3, 293.0), (77.0, 13.5, 299.0),
           (68.0, 13.4, 301.0), (60.0, 14.2, 301.0), (56.0, 15.0, 299.0),
           (53.5, 15.0, 305.0)]
    for (x, yy, z) in PTS:
        s = 0.0
        for p, L in lights:
