...
def main():
    ...
    PLAN.update({
        ...
        # 作り直し版(人間の尺度)。長室 z172..198 + R3 z198..206 + 廊下 + R4 z196..214
        11: ((23.0, 186.0, 5.80), (23.0, 186.0, 5.80)),   # 渡し板 -> 穴を越える
        12: ((21.0, 200.0, 5.80), (21.0, 200.0, 5.80)),   # 踏み石 -> 2 つ目の穴を越える
        13: ((32.0, 202.0, 5.80), (32.0, 202.0, 5.80)),   # 梁 -> 東の廊下へ
        14: ((65.0, 209.0, 7.60), (65.0, 209.0, 7.60)),   # 塞ぎ板が退いて北へ
        16: ((68.0, 213.0, 7.60), (68.0, 213.0, 7.60)),   # 出口の床が生える
    })
    PLAN.update({
