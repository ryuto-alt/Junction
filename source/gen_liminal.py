...
def act2(Y2, DW, DH):
    ...
    c10 = Conn(10, F10, 1.3, 9.0, (22.0, SILL2 + 1.2, 164.0), "gate-touch")
    GZ = 164.0
    GW, GH = 1.30, 2.35
    parts = [[], [], [], []]
    jw = 0.24
...
def act3(Y3, DW, DH):
    ...
    **6 個を全部消して、58 x 42m・高さ 28m の縦穴 1 つ**にした。
    ...
    # 水面のきらめきだけ。★これ 1 灯で「下に水がある」が伝わる。増やすと霧が白む
    plight("S3_wl0", (34.0, YB + 2.2, 192.0), COOL, 4.0, 14.0)
    ...
    # ★一周(360度)させてはいけない。降りきった段の【真上】に一周前の段が来て、
    #   ドラムの天端の頭上が 1.17m しか空かない ＝ 乗れても出られない檻になる。
    #   270 度で止めて、降りた先(南東)から柱へ抜ける。
    ...
    plight("C13_fill", (62.0, L1 + 3.4, 206.0), WARM, 7.0, 13.0)
